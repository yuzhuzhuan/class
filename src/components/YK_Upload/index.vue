<template>
    <el-upload ref="UploadRef" :drag='drag' :list-type="listType" show-file-list action="#" :limit="limit" :http-request="uploadOk" :before-upload="beforeAvatarUpload" :file-list="fileList"
        :auto-upload="true">
       <slot>
