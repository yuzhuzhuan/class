...
export default class extends Vue {
  ...
  initOpts = {
    ...
    // 插件
    plugins:
      'print preview searchreplace autolink directionality visualblocks visualchars fullscreen image link media template  codesample table hr pagebreak nonbreaking anchor insertdatetime advlist lists wordcount  help  autosave autoresize formatpainter code bdmap',
    // 工具条
    toolbar:
      ' undo redo restoredraft | cut copy paste pastetext | forecolor backcolor bold italic underline strikethrough link anchor | alignleft aligncenter alignright alignjustify outdent indent | styleselect formatselect fontselect fontsizeselect | bullist numlist | blockquote subscript superscript removeformat | table image media  hr pagebreak insertdatetime print preview | fullscreen | lineheight formatpainter  code bdmap',
    height: 650, // 编辑器高度
    min_height: 400,
